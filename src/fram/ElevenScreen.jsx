...
<button onClick={st11} className="bg-[#8489FC] mt-3 w-full text-start  relative  px-5 py-2 text-white font-black flex justify-start items-center"><img className="mr-2 h-[20px] w-[20px]" src="screens/nav.png" alt="jobrebuilder"/> Partnership Terms
