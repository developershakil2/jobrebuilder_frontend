    ...
    <>
      <div className="screen_wrapper  mx-auto flex-col flex justify-center mt-10 w-full">
        ...
        <div className="w-[285px] mx-auto px-2 mt-1   h-[40%] rounded-xl bg-[#EEEEEE] p-1">
            <div className="w-[285px] mx-auto flex justify-between items-center">
                <span className="text-xs ">Description</span>
                <span className="border-[1px] border-[#1111117e] mr-5 mb-5 text-black font-black w-[20px] h-[20px] flex justify-center items-center rounded-full"><span className="mb-2">...</span></span>
            </div>
...
<button onClick={st3} className="bg-[#8489FC] mt-3 w-[285px] mx-auto relative rounded-2xl px-5 py-2 text-white font-black">Next
