    ...
    return(
        ...
        <>
         ...
         <div className="w-full relative flex justify-start flex-col items-center">
          ...
          <div onClick={()=> setModal("none")} style={{display:modal}} id="cat_mes_desk" className="cat_message_wrap w-full h-[700px] absolute top-0 left-0 z-20 bg-[#000000cd] flex justify-center items-center flex-col">
