                    ...
                    <div className="step1_left">
                        ...
                        <div classNmae="mt-8">
                         ...
                         <div className="mt-[30px] flex-col relative flex selectStateWrapper">
                            ...
                            <button onClick={mclass} className={`flex my-4 items-center w-full ${myclass} px-4 rounded-xl h-[50px] border-2`}><img src="images/vote.png" lat="ok" className="w-[40px] h-[40px] rounded-full" /> <span className="ml-4 text-xl font-black">Unanimous (recommended)</span></button>
                          ...
                          <div className="mt-10">
                             ...
                             <div className="my-[30px]">
                                 ...
                                 <Link onClick={()=> setProgressWidth('43%')} className="px-[20px] ml-3 py-3 bg-black text-white" to="/step-11">Save And Continue </Link>
                             </div>
