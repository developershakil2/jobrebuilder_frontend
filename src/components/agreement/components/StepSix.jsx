...
const [d3, setD3] = useState('');
   ...
   const addFunc = ()=>{
       form.step6.time = v1+'_'+b1+"_"+d1;
       form.step6.cash = v2+'_'+b2;
       form.step6.equipment = v3+"_"+b3+"_"+d2;
       form.step6.others = v4+"_"+b4+"_"+d3;
       form.step6.value = total
        ...
        <div className="w-full ">
            <div className="inner_wrapper py-7 flex justify-between items-center px-5 w-[80%] mx-auto">
                    <div className="step1_left">
                        <h2 className="text-3xl font-black">Second Partner's Capital Contributions</h2>
                        <div classNmae="mt-8">
                        ...
                        <h4>What equipment was contributed?
                          ...
                          <div className="mt-10">
                             ...
                             <div className="my-[30px]">
                                 ...
                                 <Link onClick={addFunc} className="px-[20px] ml-3 py-3 bg-black text-white" to="/step-7">Save And Continue </Link>
                             </div>
